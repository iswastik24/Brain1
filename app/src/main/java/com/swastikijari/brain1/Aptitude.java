...
public class Aptitude extends AppCompatActivity {
    ...
    private  Questions Object = new Questions();
    private int score1 = 0;
    private int i,k;
    private String answer;
    private int mquestionLength=Object.Appti.length;
  //  Random r;
    @Override
            ...
            public void onFinish() {
                ...
                fscore.setText(
                        ...
                        replay.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                startActivity(new Intent(Aptitude.this,MainActivity.class));
                                finish();
                            }
                        });
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(b1.getText() == answer){
                    ...
                    Toast.makeText(Aptitude.this,"Wrong-Tryagain",Toast.LENGTH_SHORT).show();
...
public void decreasequestion(int num){
    if(num<=0){
        Toast.makeText(Aptitude.this, "No  Qusestion press Next", Toast.LENGTH_SHORT).show();
        k=1;
    }
    ...
    public  void updateQuestion(int num){
        ...
        if(k>=mquestionLength) {
            Toast.makeText(Aptitude.this, "This is last Qusestion", Toast.LENGTH_SHORT).show();
            k=0;
        }
