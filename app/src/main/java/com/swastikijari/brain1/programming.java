...
public class programming extends AppCompatActivity {
    ...
    private  Question3 Object1 = new Question3();
    private int score1 = 0;
    private int i,k;
    private String answer;
    private int mquestionLength=Object1.Appti3.length;
    //  Random r;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1=(Button)findViewById(R.id.po1);
        b2=(Button)findViewById(R.id.po2);
        b3=(Button)findViewById(R.id.po3);
        b4=(Button)findViewById(R.id.po4);
        //  r = new Random();
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(b1.getText() == answer){
                    score1++;
                    i++;
                    Toast.makeText(programming.this,"correct",Toast.LENGTH_SHORT).show();
                    
                    updateQuestion(k);

                }
                else{
                    Toast.makeText(programming.this,"Wrong-Tryagain",Toast.LENGTH_SHORT).show();
    ...
    public void decreasequestion(int num){
        if(num<=0){
            Toast.makeText(programming.this, "No  Qusestion press Next", Toast.LENGTH_SHORT).show();
            k=1;
        }
        score.setText(i + "/" + mquestionLength);
        tv1.setText(Object1.getQuestion(num));
        b1.setText(Object1.Choice1(num));
        b2.setText(Object1.Choice2(num));
        b3.setText(Object1.Choice3(num));
        b4.setText(Object1.Choice4(num));
        answer = Object1.Answers(num);
    ...
    public  void updateQuestion(int num){
        ...
        if(k>=mquestionLength) {
            Toast.makeText(programming.this, "This is last Qusestion", Toast.LENGTH_SHORT).show();
            k=0;
        }
